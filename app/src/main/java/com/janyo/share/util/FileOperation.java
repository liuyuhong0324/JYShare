...
public class FileOperation
{
	...
	public FileOperation(Context context,String path, String newFileName, String versionName) throws IOException
	{
		...
		FileOutputStream fos = context.openFileOutput(newFileName, Context.MODE_WORLD_READABLE + Context.MODE_WORLD_WRITEABLE);
	...
	{
		return context.getDir(NewFile, context.MODE_WORLD_WRITEABLE).exists();
	}
